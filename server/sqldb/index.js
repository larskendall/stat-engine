...
db.FireDepartmentEmail = db.sequelize.import('../api/fire-department-email/fire-department-email.model');
...
db.FireDepartmentEmail.belongsTo(db.FireDepartment);
db.FireDepartment.hasMany(db.FireDepartmentEmail);
