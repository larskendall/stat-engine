...
describe('calculateTimeRange', () => {
  ...
  it('should calculate time range (DAY)', function() {
    const tr = calculateTimeRange({
  ...
  it('should calculate time range with no end date provided (DAY)', function() {
    const tr = calculateTimeRange({
  ...
  it('should calculate time range with no end date provided (WEEK)', function() {
    const tr = calculateTimeRange({
      startDate: '2018-05-16T10:00:00-04:00',
  ...
  it('should calculate time range with no end date provided (MONTH)', function() {
    const tr = calculateTimeRange({
      startDate: '2018-05-16T10:00:00-04:00',
